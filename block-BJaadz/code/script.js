...
allHrsArray.forEach((val)  => {
  console.log(val.style.borderRadius = "5px")});
...
para.innerHTML = "querySelector returns an element you can maupulate but querySelectorAll returns the collection of elements in array kind of structure.";
