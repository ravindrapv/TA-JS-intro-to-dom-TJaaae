...
let topic = document.querySelector(`li`);
topic = topic.innerText = `all about document`;
...
let emailInput = document.firstElementChild
...
let is = document.querySelectorAll(`img`);
